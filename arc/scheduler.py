    ...
    def troubleshoot_ess(self, label, job, level_of_theory, conformer=-1):
        ...
        output_errors, ess_trsh_methods, remove_checkfile, level_of_theory, software, job_type, fine, trsh_keyword, \
            ...
            trsh_ess_job(label=label, level_of_theory=level_of_theory, server=job.server, job_status=job.job_status[1],
                         ...
                         memory_gb=job.total_job_memory_gb, cpus=job.cpu_cores, ess_trsh_methods=job.ess_trsh_methods,
        ...
        if not dont_rerun:
            self.run_job(label=label, xyz=xyz, level_of_theory=level_of_theory, software=software, memory=memory,
                         ...
                         directed_dihedrals=job.directed_dihedrals, cpu_cores=cpus)
        self.save_restart_dict()
